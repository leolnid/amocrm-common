...
namespace App\Orchid\Resources\Role\Layouts;
...
/**
 * Шаблон Layout для прав доступа роли
 * Может использоваться как для роли, так и для пользователя (если передать user в query)
 */
