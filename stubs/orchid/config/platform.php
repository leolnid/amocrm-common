...
/**
 * Шаблон конфигурации Orchid Platform
 * 
...
return [
    ...
    | using a multi-auth setup, you can use this option to specify the guard
    | that should be used for administrative routes. If you are
    ...
    */
    ...
    'search' => [
        // Добавьте ваши модели с Presenter и Scout
        // \App\Models\User::class
    ],
